...
export const MISSIONS: Mission[] = [
  ...
  { id: 'm-postkort', icon: '💌', title: 'Postkort i hodet', desc: 'Fortell hva du ville skrevet på et postkort hjem.' },
  { id: 'm-rodebiler', icon: '🚗', title: 'Rødbil-jakt', desc: 'Tell 20 røde biler.' },
  { id: 'm-navnskilt', icon: '🔤', title: 'Navne-skilt', desc: 'Finn skilt med bokstavene i navnet ditt, i rekkefølge.' },
  { id: 'm-takk3', icon: '🗣️', title: 'Takk på tre språk', desc: 'Si «takk» på tre forskjellige språk.' },
  { id: 'm-flaggtegn', icon: '✏️', title: 'Tegn flagget', desc: 'Tegn flagget til landet dere er i akkurat nå.' },
  { id: 'm-fjell2', icon: '⛰️', title: 'Høyeste fjell', desc: 'Pek på det høyeste fjellet du kan se i dag.' },
  { id: 'm-grenserop', icon: '🛂', title: 'Grense-ropet', desc: 'Vær først til å rope «nytt land!» ved neste grense.' },
  { id: 'm-godmorgen', icon: '☀️', title: 'God morgen', desc: 'Si god morgen på språket i landet dere våknet i.' },
  { id: 'm-bilmerke', icon: '🚙', title: 'Merke-jeger', desc: 'Finn fem forskjellige bilmerker.' },
  { id: 'm-gjettby', icon: '🏙️', title: 'Neste by', desc: 'Gjett hva neste store by på skiltet heter.' },
  { id: 'm-natur3', icon: '🌲', title: 'Naturkikkert', desc: 'Beskriv tre ting du ser i naturen akkurat nå.' },
  { id: 'm-fotostopp', icon: '📷', title: 'Familiebildet', desc: 'Bestem hvor dere skal ta dagens familiebilde.' },
  { id: 'm-hyggelig', icon: '🙏', title: 'Snille ord', desc: 'Si noe hyggelig til hver person i bilen.' },
  { id: 'm-vindu', icon: '🪟', title: 'Vindus-forsker', desc: 'Finn noe blått, noe grønt og noe gult ut av vinduet.' },
  { id: 'm-longest', icon: '📏', title: 'Lengste ord', desc: 'Finn det lengste stedsnavnet på et veiskilt i dag.' },
]
