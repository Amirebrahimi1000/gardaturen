...
export const PLATES: Plate[] = [
  ...
  { code: 'RO', country: 'Romania', flag: '🇷🇴', onRoute: false },
  { code: 'SK', country: 'Slovakia', flag: '🇸🇰', onRoute: false },
  { code: 'BG', country: 'Bulgaria', flag: '🇧🇬', onRoute: false },
  { code: 'LT', country: 'Litauen', flag: '🇱🇹', onRoute: false },
  { code: 'LV', country: 'Latvia', flag: '🇱🇻', onRoute: false },
  { code: 'EST', country: 'Estland', flag: '🇪🇪', onRoute: false },
  { code: 'UA', country: 'Ukraina', flag: '🇺🇦', onRoute: false },
  { code: 'MC', country: 'Monaco', flag: '🇲🇨', onRoute: false },
  { code: 'M', country: 'Malta', flag: '🇲🇹', onRoute: false },
  { code: 'TR', country: 'Tyrkia', flag: '🇹🇷', onRoute: false },
]
