...
export const PLATES: Plate[] = [
  ...
  { code: 'B', country: 'Belgia', flag: '🇧🇪', onRoute: false },
  { code: 'A', country: 'Østerrike', flag: '🇦🇹', onRoute: false },
  { code: 'FL', country: 'Liechtenstein', flag: '🇱🇮', onRoute: false },
  { code: 'F', country: 'Frankrike', flag: '🇫🇷', onRoute: false },
  ...
  { code: 'L', country: 'Luxembourg', flag: '🇱🇺', onRoute: false },
]
